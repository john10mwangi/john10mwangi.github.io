...
<div class="css/mkulima.css/container">
			...
			if (!preg_match("/^[a-zA-Z ]+$/",$county)) {
			  $error = true;
			  $county_error = "Username can only contain alphabets and spaces";
			}

			if (!preg_match("/^[a-zA-Z]+$/",$type)) {
				  $error = true;
				  $type_error = "Usertype can only contain alphabets";
			}
			...
			if (!$error){
			  ...
			  $query = "INSERT INTO users( firstname, lastname, county, phone,
			   ...
			   VALUES('$firstname', '$lastname', '$county', '$phone', '$email', '$password', '$id','$type')";
			 ...
			 ?>
			       ...
			       <br><br>
			       					    ...
			       					    <div class="col-md-7">				<legend> COUNTY:</legend>
												...
												<div class="row">
													<div class="col-md-5">				<legend> USER TYPE:</legend>
														<select name="type" >
															<option value="">---------------</option>
															<option value="farmer" >Farmer</option><option value="trader">Trader</option>
														</select>
																	<span class="badge btn-danger"><?php if (isset($type_error)) {
																		echo $type_error;
																	}?></span></div>
																</div>
			 </br></br>
