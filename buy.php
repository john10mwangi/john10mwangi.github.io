...
if(isset($_REQUEST['submit'])){
  ...
  extract($placed);
    ...
    echo '<tr >';
    echo '<th> PRODUCT NAME </th> <th>PRODUCT PRICE</th> <th> QUANTITY </th> <th> SALE PRICE </th> <th> RECEIPT NO </th>';
    echo '</tr>';
    ...
    if ($quantity[$x]!=0 && $quantity[$x] <= $available[$x]) {
      ...
      echo '</tr>';
      echo '<tr>';
      echo '<a class="btn btn-default btn-group btn-primary" href="sokobuy.php">ADD ITEMS</a>';
      echo '</tr>';
      echo '</form>';
      echo '</div>';
      echo '</div>';
