                ...
                <a href= "help/index.html" class="link"> ABOUT $ HELP </a>
						...
						<div class="column2">
								...
								<section class="sec">
									...
									<header>
										<h2 class="title"> SOKO SELL </h2>
										<table id="nav" "border='0' cellpadding="5">
											<tr>
												<th><a href="">ALL</a></th><th><a href="buy_cereals.php"> CEREALS </a></th><th><a href="buy_vegetables.php"> VEGETABLES </a></th>
